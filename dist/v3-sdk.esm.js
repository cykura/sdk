...
function mostSignificantBit(x) {
  ...
  !JSBI.lessThanOrEqual(x, MaxUint128$1) ? process.env.NODE_ENV !== "production" ? invariant(false, 'MAX') : invariant(false) : void 0;
  var msb = 0;
...
var TickMath = /*#__PURE__*/function () {
  ...
  TickMath.getSqrtRatioAtTick = function getSqrtRatioAtTick(tick) {
    ...
    if (tick > 0) ratio = JSBI.divide(MaxUint128$1, ratio); // back to Q32
...
var Pool = /*#__PURE__*/function () {
  ...
  function Pool(tokenA, tokenB, fee, sqrtRatioX32, liquidity, tickCurrent, tickDataProvider) {
    ...
    !(JSBI.greaterThanOrEqual(JSBI.BigInt(sqrtRatioX32), tickCurrentSqrtRatioX32) && JSBI.lessThanOrEqual(JSBI.BigInt(sqrtRatioX32), nextTickSqrtRatioX32)) ? process.env.NODE_ENV !== "production" ? invariant(false, 'PRICE_BOUNDS') : invariant(false) : void 0;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _context.abrupt("return", [CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX32, liquidity, tickCurrent, this.tickDataProvider), accounts]);
  ...
  /*#__PURE__*/
  function () {
    var _getInputAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(outputAmount, sqrtPriceLimitX32) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return _context2.abrupt("return", [CurrencyAmount.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX32, liquidity, tickCurrent, this.tickDataProvider)]);
...
export { ADDRESS_ZERO, BITMAP_SEED, FACTORY_ADDRESS, FEE_SEED, FeeAmount, FullMath, IDL, LOCAL_PROGRAM_ID, LiquidityMath, Multicall, NoTickDataProvider, NonfungiblePositionManager, OBSERVATION_SEED, POOL_INIT_CODE_HASH, POOL_SEED$1 as POOL_SEED, POSITION_SEED, Payments, Pool, Position, Route, SelfPermit, SqrtPriceMath, Staker, SwapMath, SwapQuoter, SwapRouter, TICK_SEED, TICK_SPACINGS, Tick, TickList, TickMath, Trade, computePoolAddress, encodeRouteToPath, encodeSqrtRatioX32, generateBitmapWord, i16ToSeed, i32ToSeed, isSorted, lsb, maxLiquidityForAmounts, mostSignificantBit, msb, nearestUsableTick, nextInitializedBit, priceToClosestTick, tickPosition, tickToPrice, toHex, tradeComparator, u16ToSeed, u32ToSeed };
